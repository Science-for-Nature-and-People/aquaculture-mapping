...
ggarrange(ecology_score, community_harvest_score, harvest_score, community_restoration_score, community_harvest_score, ncol = 2, nrow = 3, widths = c(1,1), heights = c(1,1))
...
g <- ecology_score + community_harvest_score + harvest_score + community_restoration_score + community_harvest_score
