...
ggarrange(ecology_score, harvest_score, community_restoration_score, community_harvest_score, community_harvest_score, coastwide_conservation_score, ncol = 3, nrow = 2)
