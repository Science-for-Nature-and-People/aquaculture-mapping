...
estuary_sf$estuary_or_subbasin
...
```{r}
#changing names in SNAPP_polygon file to match new dataset
SNAPP_estuary_polygons$estuary[SNAPP_estuary_polygons$estuary == "North Juan de Fuca Basin: Gorge Waterway, Sooke/Victoria, Ayum Creek"] <- "North Juan de Fuca Basin"

SNAPP_estuary_polygons$estuary[SNAPP_estuary_polygons$estuary == "SF Bay North Bay/San Pablo Bay (north of Richmond Bridge)"] <- "SF Bay North/San Pablo Bay"

SNAPP_estuary_polygons$estuary[SNAPP_estuary_polygons$estuary == "SF Bay Central Bay South  (south of Alameda/South SF to Dumbarton Bridge)"] <- "SF Bay Central Bay South "

SNAPP_estuary_polygons$estuary[SNAPP_estuary_polygons$estuary == "Northern Puget Sound:  Samish Bay, Bellingham Bay, Lummi Bay, Drayton Harbor, Fidalgo Bay, Padilla Bay"] <- "Northern Puget Sound"

# SNAPP_estuary_polygons$estuary[SNAPP_estuary_polygons$estuary == ""] <- ""

SNAPP_estuary_polygons$estuary
...
bar_data_long <- bar_data %>% 
   pivot_longer(-c("estuary", "lat", "long"), names_to = "category", values_to = "score")
