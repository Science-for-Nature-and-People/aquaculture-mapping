...
# using cowploat and patchwork package to make a matrix
library(patchwork)
library(cowplot)

plot_patch <- cowplot::plot_grid(plotlist = plot_list, ncol=1)

plot_patch | base_map

(plot_list[[1]] / plot_list[[2]] / plot_list[[3]])| (base_map)
