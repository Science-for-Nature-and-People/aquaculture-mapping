...
supplement_figures <- function(x1, x2, y1, y2){
  ...
  plot_list_zoom <- vector("list", length = data_len)
...
sup_zoom_funct <- supplement_figures(-123.5, -118.5, 34, 38.5)
sup_zoom_funct
...
supp_zoom_2 <- (wrap_plots(plot_list_zoom_2[1:len], ncol = 1)) | base_map_zoom_2
supp_zoom_2
