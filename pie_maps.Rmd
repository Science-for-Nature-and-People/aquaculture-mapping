...
estuary_sf <- left_join(data_scores, SNAPP_estuary_points, by = "Estuary") 
...
# estuary_sf <- left_join(data_scores, SNAPP_estuary_polygons, by = "Estuary")
...
SNAPP_estuary_polygons_centroid$Estuary_Na
