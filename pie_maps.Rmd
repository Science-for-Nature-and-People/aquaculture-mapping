...
```{r}
#trying mapview package which allows for graph popups

#just the points
mapview(estuary_sf)

#adding color based on a column
mapview(estuary_sf,
        zcol = "ecological")

#can use popupGraph() to insert ggplot outputs
...
```{r projection tweaking}
# trying to make scatterpie plots round

```

```{r}
#Adding plot to map using mapview or leaflet and popups to view each pie chart

#making plots & saving as svg to use in leaflet
for( i in 1:10){
...
#first tried using just one of the plots for all the points to see if it would work, but it did not
mapview(estuary_sf,
